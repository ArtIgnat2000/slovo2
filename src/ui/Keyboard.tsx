...
/**
 * Ё стоит в начале третьей строки — как на стандартной мобильной русской
 * раскладке (iOS/Gboard). Без неё нерешаемы «напиши слово» и «зрительный
 * диктант» для слов с ё (берёза).
 */
const ROWS = [
